...
class ModelConfigManager:
    ...
    def __init__(self, console: Optional[Console] = None):
        ...
        # Default system prompt to encourage tool usage - keep it simple and clear
        self.system_prompt = """You are a helpful security testing assistant. You have access to powerful tools for penetration testing.

When the user asks you to perform security testing:
- Use the available tools to get real results
- Call tools one at a time and analyze the results
- If the user specifies multiple steps, complete them sequentially using tool calls

When you receive tool results, decide what to do next based on those results."""

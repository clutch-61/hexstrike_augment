...
```bash
# 方式A：使用提供的配置文件
export MCP_CONFIG=/disk1/users/renbh/ollama_mcp/rag_mcp_config.json
...
```json
{
  "mcpServers": {
    "rag-knowledge-base": {
      "command": "python3",
      "args": [
        "/disk1/users/renbh/ollama_mcp/rag_mcp_server.py"
      ],
      "env": {
...
```bash
# 确保数据库目录可写
chmod -R 755 /disk1/users/renbh/ollama_mcp/chroma_db
```
